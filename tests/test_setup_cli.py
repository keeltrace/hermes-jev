...
class SetupCliTests(unittest.TestCase):
    def _mutations(self):
        ...
        return patch.object(cli,"save_profile",return_value=fake_path), patch.object(cli.shared_context,"reconcile_enabled",return_value={"changed":True}), patch.object(cli.assistant,"install",return_value={}), patch.object(cli.assistant,"disable",return_value={})
